...
(function () {
  ...
  */
  ...
  domReady(function () {
    ...
    console.log('js-imported-booklist-tpl', $("#js-imported-booklist-tpl").html());
    DBG.displayItemTemplate = String($("#js-imported-booklist-tpl").html());
    formItemTemplate = String($("#item_form").html());
    onlineStoresTpl = String($('#online-matches ul').html());
