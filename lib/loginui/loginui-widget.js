...
(function () {
  ...
  function showGuestUi(currentUser) {
  ...
  function showUserUi(currentUser) {
  ...
  function logout(ev) {
    ...
    request.post('/sessions').when(authenticatedUi);
    fb._FB.logout();
  }
 ...
 function copyPassphrase() {
  ...
  function initEvents() {
    ...
    console.log("[loginui] running el widget");
    initialLogin();
  }

  domReady(initEvents);

  module.exports.init = function (_handleUser) {
    fb.init();
    console.log('init', window.FB);
    handleUser = _handleUser;
  };
}());
